...
describe("StatsGrid", () => {
  it("renders five metric cards with values", () => {
    render(
      <StatsGrid
        stats={[
          ...
          { label: "Plus Burn (5h/7d)", value: "0.7 / 1.2", meta: "Primary 0.7 acc/5h · Secondary 1.2 acc/7d", icon: Flame, trend: SAMPLE_TREND, trendColor: "#ef4444" },
    ...
    expect(screen.getByText("Primary 0.7 acc/5h · Secondary 1.2 acc/7d")).toBeInTheDocument();
